...
const Login = () => {
  ...
  return (
    <>
      ...
      >
        <h1 id="title-login" data-testid="login-title" className="text-3xl font-semibold text-center mb-6">
          Desafio ToDoList
        </h1>
        
        <label htmlFor="input-login-email" className="block text-sm font-medium text-gray-700 mb-2" data-testid="label-login-email">
          Email
          <input
            type="email"
            name="input-login"
        ...
        <label htmlFor="input-login-password" className="block text-sm font-medium text-gray-700 mb-2">
          ...
          <div className="relative">
            ...
            <button
              ...
              data-testid="button-login-password-show"
